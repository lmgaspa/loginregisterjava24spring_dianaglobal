...
public class EmailChangeEmailService {
    ...
    private String buildHtmlConfirm(String name, String confirmLink, int minutes) {
        ...
        return """
            <!doctype html>
            <html lang="en">
            <head><meta charset="utf-8"><meta name="viewport" content="width=device-width"/><title>Confirm new e-mail</title></head>
            <body style="font-family:Arial,Helvetica,sans-serif;background:#f6f7f9;padding:24px">
              <div style="max-width:640px;margin:0 auto;background:#fff;border:1px solid #eee;border-radius:12px;overflow:hidden">
                <div style="background:linear-gradient(135deg,#0a2239,#0e4b68);color:#fff;padding:16px 20px;">
                  <table width="100%%" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                    <tr>
                      <td style="width:64px"><img src="%s" alt="%s" width="56" style="display:block;border-radius:6px"></td>
                      <td style="text-align:right">
                        <div style="font-weight:700;font-size:18px"><strong>%s</strong></div>
                        <div style="opacity:.9;font-size:12px;margin-top:4px">Confirm your new e-mail</div>
                      </td>
                    </tr>
                  </table>
                </div>
    ...
    private String buildHtmlChanged(String name) {
        ...
        return """
            <!doctype html>
            <html lang="en">
            <head><meta charset="utf-8"><meta name="viewport" content="width=device-width"/><title>E-mail updated</title></head>
            <body style="font-family:Arial,Helvetica,sans-serif;background:#f6f7f9;padding:24px">
              <div style="max-width:640px;margin:0 auto;background:#fff;border:1px solid #eee;border-radius:12px;overflow:hidden">
                <div style="background:linear-gradient(135deg,#0a2239,#0e4b68);color:#fff;padding:16px 20px;">
                  <table width="100%%" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                    <tr>
                      ...
                      <td style="text-align:right">
                        <div style="font-weight:700;font-size:18px"><strong>%s</strong></div>
                        <div style="opacity:.9;font-size:12px;margin-top:4px">E-mail updated</div>
                      </td>
                    </tr>
                  </table>
                </div>
    ...
    private String buildHtmlAlertOld(String name, String supportUrl) {
        ...
        return """
            <!doctype html>
            <html lang="en">
            <head><meta charset="utf-8"><meta name="viewport" content="width=device-width"/><title>Security alert</title></head>
            <body style="font-family:Arial,Helvetica,sans-serif;background:#f6f7f9;padding:24px">
              <div style="max-width:640px;margin:0 auto;background:#fff;border:1px solid #eee;border-radius:12px;overflow:hidden">
                <div style="background:linear-gradient(135deg,#0a2239,#0e4b68);color:#fff;padding:16px 20px;">
                  <table width="100%%" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                    <tr>
                      ...
                      <td style="text-align:right">
                        <div style="font-weight:700;font-size:18px"><strong>%s</strong></div>
                        <div style="opacity:.9;font-size:12px;margin-top:4px">Security alert</div>
                      </td>
                    </tr>
                  </table>
                </div>
